...
<?php
	...
	$maintenence_details =$_REQUEST['maintenence_details'];
	$date =$_REQUEST['date'];
...
?>
	<div>
		...
		<p><input type="text" name="maintenence_details" placeholder="Enter maintenence details" 
		required value="<?php echo $row['maintenence_details'];?>" /></p>
