...
<?php
	...
	$update="update vehicle set vehicle_name='".$vehicle_name."',
	vehicle_number='".$vehicle_number."'  where id='".$id."'";
	mysqli_query($con, $update) or die(mysqli_error());
	$status = "Record Updated Successfully. </br></br>
	<a href='vehicle_list.php'>View Updated list</a>";
...
?>
	<div>
		...
		<p><input type="text" name="vehicle_name" placeholder="Enter vehicle name" 
		required value="<?php echo $row['vehicle_name'];?>" /></p>
