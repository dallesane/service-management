...
$id=$_REQUEST['id'];
$query = "SELECT * from materials_supply where id='".$id."'"; 
...
<body>
	...
	<h2>Edit materials ordered and supply list</h2>
...
<?php
  ...
  $supplied_date =$_REQUEST['supplied_date'];
  ...
  $status =$_REQUEST['status'];
	...
	$update="update materials_supply set ordered_date='".$ordered_date."',
	supplied_date='".$supplied_date."', contractor_name='".$contractor_name."', item_name='".$item_name."', price='".$price."', status='".$status."'  where id='".$id."'";
	mysqli_query($con, $update) or die(mysqli_error());
	$status = "Record Updated Successfully. </br></br>
	<a href='materials_supply_list.php'>View Updated Record</a>";
...
?>
    ...
    <p><input type="text" name="ordered_date" placeholder="Enter order date" 
    required value="<?php echo $row['ordered_date'];?>" /></p>
    <p><input type="text" name="supplied_date" placeholder="Enter supplied date" 
    required value="<?php echo $row['supplied_date'];?>" /></p>
